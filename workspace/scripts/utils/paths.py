...
# workspace/ 是脚本运行时的工作根目录
# 所有脚本都在 workspace/scripts/ 下，所以 parent.parent = workspace/
BASE_DIR   = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
# BASE_DIR = openclaw-assistant-template/workspace
...
# v3.7 保留的展示文件（只读，不作计算输入）
RECENT_MD  = os.path.join(MEMORY_DIR, "recent.md")
ERRORS_MD  = os.path.join(MEMORY_DIR, "errors.md")
GROWTH_MD  = os.path.join(MEMORY_DIR, "growth.md")
CORE_MD    = os.path.join(MEMORY_DIR, "core.md")
PROJECT_MD = os.path.join(MEMORY_DIR, "project.md")
